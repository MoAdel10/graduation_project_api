...
const {SignUp,Login,getUserProfieWithToken,updateUserProfile,Logout,verifyOTP,requestPasswordReset,verifyResetToken,resetPassword,requestOTP} = require("../Controllers/AuthController")
